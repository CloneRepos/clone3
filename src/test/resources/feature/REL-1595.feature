@ST_6588 @tagtagtag @this_is_story_tag
...
@SC_43203 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_43204 @third_scenario_tag
...
@SC_43205 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_43206 @fifth_scenario_tag
